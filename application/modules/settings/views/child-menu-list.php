                                    ...
                                    <tr>
                                     ...
                                     <td><?php echo $pdt->name;?>    </td>
                                        <td><?php echo $pdt->url;?>    </td>
                                         <td><?php echo $pdt->position;?>    </td>
                                          <td><?php echo $pdt->icon;?>    </td>
                                               ...
                                               <a  class="btn btn-success m-r-5 text-white" href="<?php echo base_url()."menu/definition/role/{$pdt->id}"; ?>" >Role</a> 
                                            
                                             <a  class="btn btn-danger m-r-5 text-white" href="<?php echo base_url()."menu/definition/user/{$pdt->id}"; ?>" >User</a>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url()."settings/sidebarmenu/edit/$pdt->id" ?>" class="btn btn-sm btn-primary me-1">
