            ...
            <!-- Button trigger modal -->
               <div class="right">
                ...
                <button type="button" class="btn btn_bg" data-bs-toggle="modal" data-bs-target="#add_new">
                    <i class="fa-solid fa-plus"></i> Add New Categories
                </button>
                   <?php //endif; ?>
            </div>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>service/categories/update" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                          ...
                          <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="eamount">Amount <span class="text-danger">*</span></label>
                                <input type="text" name="eamount" id="eamount" class="form-control" value="<?php echo $pdt->amount; ?>"  >
                                <span class="text-danger small"><?php echo form_error('eamount'); ?></span>
                            </div>
                        </div>
...
<div class="modal fade" id="add_new" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>service/categories/create" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
...
<script>
    function confirmDelete(userId){
        ...
        if (result.value) {
           window.location.href = "<?php echo base_url(); ?>service/categories/delete/"+userId;
        }
        }); 
