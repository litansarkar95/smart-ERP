...
<div class="card mt-3">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo base_url(); ?>service/warranty/invoice"
              method="post"
              enctype="multipart/form-data">
...
<div class="col-md-3 col-sm-4 col-6 mb-3">
  <div class="d-flex align-items-center">
    <div class="form-check me-2">
      <input class="form-check-input" type="checkbox" id="problem_id<?php echo $cat->name; ?>" name="problem_id[]" value="1">
      <label class="form-check-label" for="problem_id<?php echo $cat->name; ?>">
        <?php echo $cat->name; ?>
      </label>
    </div>
    <input type="number" name="rate[]" class="form-control form-control-sm" value="0" min="0" style="width: 70px;">
  </div>
</div>
