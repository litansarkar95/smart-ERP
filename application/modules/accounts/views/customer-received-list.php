  ...
  <div class="row px-3">
    <div class="col-12">
      <div class="content">
        <div class="row">
          <div class="col-auto">
           <h3>Customer Received  </h3>
          </div>
          <div class="col-auto ms-auto">
            <!-- Button trigger modal -->
               <div class="right">
                 <?php if (has_permission('products', 'create')): ?>
                <a type="button" href="<?php echo base_url(); ?>accounts/customerReceived" class="btn btn_bg" >
                    <i class="fa-solid fa-plus"></i> Add New Customer Received 
                </a>
                   <?php endif; ?>
            </div>
                                ...
                                <?php foreach ($allPdt  as $pdt   ): ?>
                                    <tr>
                                        <td>
                                           ...
                                           <td><?php echo date("d-m-Y",$pdt->received_date);?>  </td>
                                    ...
                                    <div class="btn-group" role="group">
                                           ...
                                           <a href="<?php echo base_url()."accounts/customerReceived/invoice/$pdt->id"?>" target="_blank" class="btn btn-sm btn-success me-1">
