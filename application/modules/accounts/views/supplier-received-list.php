          ...
          <div class="col-auto ms-auto">
            <!-- Button trigger modal -->
               <div class="right">
                ...
                <a type="button" href="<?php echo base_url(); ?>accounts/supplierReceived" class="btn btn_bg" >
                    <i class="fa-solid fa-plus"></i> Add New Supplier Received 
                </a>
                   <?php endif; ?>
            </div>
                            ...
                            <?php if (!empty($allPdt)):
                                ...
                                <?php foreach ($allPdt  as $pdt   ): ?>
                                    ...
                                    <div class="btn-group" role="group">
                                           ...
                                           <a href="<?php echo base_url()."accounts/supplierReceived/invoice/$pdt->id"?>" target="_blank" class="btn btn-sm btn-success me-1">
