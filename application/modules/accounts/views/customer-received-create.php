        ...
        <div class="card-body">
            ...
            <div class="col-md-4 mb-3">
               ...
               <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control today" value="">
                </div>   </div>
            ...
            <form id="paidBillForm" method="post" action="<?= base_url('accounts/customerReceived/save_due_collection'); ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        <div>
                            <label for="bank_id">Bank / Cash</label>
                            <select name="bank_id" id="bank_id" class="form-control" required>
                                <option value="">Select Bank</option>
                                <option value="1">Cash (1001)</option>
                                <option value="5">DBBL BANK</option>
                            </select>
                        </div>
            ...
            if (res.status === 'success') {
                $.each(res.data, function (i, row) {
                    tbody += `
                        <tr>
                            <td>${sl++}</td>
                            <td><input type="text" name="invoice_no[]" class="form-control" value="${row.invoice_no}" readonly></td>
