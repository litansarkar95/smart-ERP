<?php
class Sreturnitem extends MX_Controller
{
  public function __construct() {
    parent::__construct();
       $this->load->model("sales_model");
       $this->load->model("sreturnitem_model");
...
public function list()
{
    ...
    $data['allPdt']       = $this->sreturnitem_model->getSalesReturnList();
...
public function invoice($id)
{
    ...
    $data['active']       = "invoice";
    $data['title']        = "invoice"; 
    $data['allPdt']       = $this->sreturnitem_model->getSalesReturnList($id);
    $data['allDets']       = $this->sreturnitem_model->SalesReturnItemDetailsList($id);
    $this->load->view('sales-return-invoice', $data);
 }
 
    public function get_products_by_customer($customer_id) {
        $data = $this->sreturnitem_model->get_products_by_customer($customer_id);
    ...
    public function get_serial_numbers_by_product($product_id, $customer_id) {
        $data = $this->sreturnitem_model->get_serial_numbers_by_product($product_id, $customer_id);
       $result = [];
...
public function create() {
    if($this->input->post()) {
        ...
        if(empty($items)){
            ...
            redirect('sales/sreturnitem');
        }

        $this->db->trans_start();

        // ---------- INSERT MASTER ----------
        $int_no = $this->sreturnitem_model->number_generator();
