...
public function index()
{
    ...
    $data = array();
    $data['active'] = "products/groups";
    $data['title'] = "Products Groups"; 
    $data['allPdt']       = $this->main_model->getRecordsByOrg("products_groups");
 ...
 public function create()
{
  ...
  if ($this->form_validation->run() == NULL) {
    ...
    if ($this->common_model->save_data("products_groups", $data)) {
   ...
   redirect(base_url() . "products/groups");
  }
...
public function delete($id) {
  ...
  if ($dt) {
      ...
      $this->common_model->delete_data("products_groups", array("id" => $id),$id);
