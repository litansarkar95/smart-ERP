            ...
            <!-- Button trigger modal -->
               <div class="right">
                ...
                <button type="button" class="btn btn_bg" data-bs-toggle="modal" data-bs-target="#add_new">
                    <i class="fa-solid fa-plus"></i> Add New Product Groups
                </button>
                   <?php endif; ?>
            </div>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white" style="background: linear-gradient(90deg, #FF6B6B, #FFA05A);">
                <h5 class="modal-title" id="exampleModalLabel">Edit Products Groups</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>products/groups/update" method="post" enctype="multipart/form-data">
                    <div class="row">
...
<div class="modal fade" id="add_new" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white" style="background: linear-gradient(90deg, #FF6B6B, #FFA05A);">
                <h5 class="modal-title" id="exampleModalLabel">Add New Products Groups</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>products/groups/create" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
...
<script>
    function confirmDelete(userId){
        ...
        if (result.value) {
           window.location.href = "<?php echo base_url(); ?>products/groups/delete/"+userId;
        }
        }); 
