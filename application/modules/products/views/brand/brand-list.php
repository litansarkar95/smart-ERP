      ...
      <div class="content">
        <div class="row">
          ...
          <div class="col-auto ms-auto">
           ...
           <div class="right">
                <?php if (has_permission('products/brands', 'create')): ?>
                <button type="button" class="btn btn_bg" data-bs-toggle="modal" data-bs-target="#add_new">
                    <i class="fa-solid fa-plus"></i> Add New Brands
                </button>
                   <?php endif; ?>
            </div>
                            ...
                            <?php if (!empty($allPdt)):
                                ...
                                <?php foreach (
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                            <img src="<?= base_url('public/images/brands/'.($pdt->picture ?: 'default.png')); ?>" width="40px" alt="Image">
                                                        </td>
                                        ...
                                        <td class="text-center">
                                            <?php if (has_permission('products/brands', 'edit')): ?>
                                            <a href="#" data-id="<?php echo $pdt->id;?>"   data-name="<?php echo $pdt->name;?>" data-bs-toggle="modal" 
                                             ...
                                             <?php endif; ?>
                                            <?php if (has_permission('products/brands', 'delete')): ?>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>products/brands/update" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
							...
							<label for="is_active">Status <span class="text-error"> *</span></label>
								...
								<option value="1" <?php if ($pdt->is_active == 1) {    echo "selected";
                                        ...
                                        <i class="fa fa-angle-double-down select-icon"></i>		</div>
                        ...
                        <div class="col-md-12">
                                                              ...
                                                              <div class="row">
                                            <div class="col-md-10">
                                            <label for="epic">Picture</label>
                                                <input type="file" accept="image/*" name="epic" class="form-control file-input-change" data-id="eimage" aria-invalid="false">
                                                 <span class="text-error small"><?php echo form_error('epic'); ?></span>
                                            </div>
                                            <div class="col-md-2 align-self-center mt-3">
                                                <img src="<?= base_url('public/images/brands/'.($pdt->picture ?: 'default.png')); ?>" id="eimage" class="table-img">
                                            </div>
                                        </div>
                                        	</div>
                    </div>
...
<div class="modal fade" id="add_new" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>products/brands/create" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Name Field -->
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <label for="name">Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter Brand Name" required>
...
<script>
    function confirmDelete(userId){
        ...
        if (result.value) {
            window.location.href = "<?php echo base_url(); ?>/products/brands/delete/"+userId;
        }
        }); 
