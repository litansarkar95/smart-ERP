	<nav class="navbar navbar-expand-lg my_header_nav">
	 ...
	 <?php
                        ...
                        ?>
                             <li class="nav-item">
										          <a class="nav-link" href="#">Super Admin <i class="fas fa-caret-down"></i></a>
										          <ul class="nav_sub_menu">
										            <li><a href="<?php echo base_url(); ?>branch/organization">Organization</a></li>
										          	<li><a href="<?php echo base_url(); ?>branch">Branch</a></li>
										          	<li><a href="<?php echo base_url(); ?>branch/staff">Branch Staff</a></li>
										          	<li><a href="<?php echo base_url(); ?>settings/sidebarmenu">Sidebar Menu Definition</a></li>
										          	<li><a href="<?php echo base_url(); ?>settings/permissions">Permissions Menu</a></li>
										          </ul>
										        </li>
...
?>
<li class="nav-item <?= $has_children ? 'submenu' : ''; ?> <?= $is_active; ?> <?= $is_parent_open; ?>">
  <a href="<?= !empty($menu['url']) ? site_url($menu['url']) : 'javascript:void(0)'; ?>" class="nav-link <?= $is_active; ?>">
     <?= $menu['name']; ?>
...
<?php
    ...
    <!-- ====================== Sidebar Menu ====================== -->
       <ul class="navbar-nav me-auto mb-2 mb-lg-0 header_menu">
        ...
        <!-- Static Logout -->
         <li class="nav-item">
	 <a class="nav-link" href="<?= base_url('logout'); ?>">Logout     <i class="fa-solid fa-share-from-square"></i></a>
